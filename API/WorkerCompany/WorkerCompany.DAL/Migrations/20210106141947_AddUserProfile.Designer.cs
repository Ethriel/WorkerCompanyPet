...
namespace WorkerCompany.DAL.Migrations
{
    ...
    [Migration("20210106141947_AddUserProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkerCompany.DAL.Models.AppUserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkerCompany.DAL.Models.WorkerCopy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WorkerCompany.DAL.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WorkerCompany.DAL.Models.AppUser", b =>
                {
                    b.HasOne("WorkerCompany.DAL.Models.AppUserProfile", "AppUserProfile")
                        .WithOne("AppUser")
                        .HasForeignKey("WorkerCompany.DAL.Models.AppUser", "AppUserProfileId")
                        .OnDelete(DeleteBehavior.Cascade);
